...
public class CloseCoalActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        record = DataSupport.where("planId = ?", String.valueOf(planId)).findLast(CloseCoalDecide.class);
    ...
    public void initView() {//责令关闭矿井决定书
        ...
        titleBar.getImBack().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ZDialogUtils.showDialog(CloseCoalActivity.this, "您还未保存修改，如需保存，请点击右上'完成'", new CallBack0() {
                    @Override
